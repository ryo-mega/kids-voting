...
ActiveRecord::Schema.define(version: 2020_09_02_131923) do
  ...
  create_table "candidates", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["politician_id"], name: "index_candidates_on_politician_id"
  end
  ...
  create_table "politicians", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "candidates", "politicians"
  add_foreign_key "users", "prefectures", column: "residence_id"
end
